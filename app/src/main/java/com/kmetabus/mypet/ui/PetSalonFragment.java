...
동물 뷰티
 */
public class PetSalonFragment extends Fragment implements OnListItemClickListener{
        ...
        public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            NodeList nl = ListViewModel.getBeaNl();
  //System.out.println("location "+ location);
            ...
            if (nl == null || nl.getLength() == 0) {
                nl = AnimalHospitalList.getList(lat, logi, ctx2, xmlnew, "B"); // data를 가져온다
            }
